...
/***/ 0:
/*!****************************************************!*\
  !*** D:/webProject/mallproject/xiaofanshu/main.js ***!
  \****************************************************/
...
var _websocket = _interopRequireDefault(__webpack_require__(/*! ./utils/websocket.js */ 36));
...
/***/ 27:
/*!****************************************************!*\
  !*** D:/webProject/mallproject/xiaofanshu/App.vue ***!
  \****************************************************/
/*! no static exports found */
...
/***/ 28:
/*!*****************************************************************************!*\
  !*** D:/webProject/mallproject/xiaofanshu/App.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 29:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/webProject/mallproject/xiaofanshu/App.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _emojiUtil = __webpack_require__(/*! ./utils/emojiUtil.js */ 41);
var _fileUtil = __webpack_require__(/*! ./utils/fileUtil.js */ 37);
var _list = _interopRequireDefault(__webpack_require__(/*! ./uni_modules/uview-ui/libs/config/props/list.js */ 43));
...
var TUICallKit = uni.requireNativePlugin('TencentCloud-TUICallKit');
// 监听通话的状态，例如：异常、通话开始、结束等。
var TUICallingEvent = uni.requireNativePlugin('globalEvent');
// 目前仅提供如下接口：结束通话，设置用户视频画面的渲染模式
var TUICallEngine = uni.requireNativePlugin('TencentCloud-TUICallKit-TUICallEngine');
var _default = {
  onLaunch: function onLaunch() {
    ...
    this.$sqliteUtil.openSqlite().then(function (res) {
      ...
      // 创建一个存储表情的表
      _this.$sqliteUtil.SqlExecute("CREATE TABLE IF NOT EXISTS emoji_list (\n\t\t\t\t\"id\"\n\t\t\t\tINTEGER PRIMARY KEY AUTOINCREMENT,\n\t\t\t\turl TEXT UNIQUE,\n\t\t\t\tname TEXT UNIQUE\n\t\t\t);").then(function (res) {
        // 判断表情是否存在，不存在则插入，异步方法
        _emojiUtil.emojiList.forEach(function (res, index) {
          _this.insertEmoji(res);
        });
      });
    });
  ...
  onShow: function onShow() {
    ...
    uni.onNetworkStatusChange(function (res) {
      if (res.isConnected) {
        ...
        if (_this2.$ws.socketTask == null && uni.getStorageInfoSync('userInfo') != null) {
          _this2.$ws.init();
        }
      } else {
        uni.showToast({
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                sql1 = "SELECT * FROM emoji_list WHERE name='".concat(item.name, "'");
                _this3.$sqliteUtil.SqlSelect(sql1).then(function (res) {
                  if (res.length == 0) {
                    (0, _fileUtil.saveFile)(item.url).then(function (res) {
                      var sql2 = "INSERT INTO emoji_list (url,name) VALUES (\"".concat(res, "\",\"").concat(item.name, "\")");
                      _this3.$sqliteUtil.SqlExecute(sql2);
                    });
                  }
                });
              case 2:
...
/***/ 46:
/*!**************************************************************************************!*\
  !*** D:/webProject/mallproject/xiaofanshu/App.vue?vue&type=style&index=0&lang=scss& ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 47:
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/webProject/mallproject/xiaofanshu/App.vue?vue&type=style&index=0&lang=scss& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
